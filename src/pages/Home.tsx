    ...
    <main>
      ...
      <section id="services" className="py-20 px-8 md:px-20 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 mb-12 max-w-lg">
            Furniture, appliances, renovation debris, full estate cleanouts — we haul it all so you don't have to.
          </p>
      ...
      <section id="about" className="py-20 px-8 md:px-20 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="text-xs font-bold tracking-widest uppercase mb-2" style={{ color: business.colorPrimary }}>
              About LOW Price Junk Removal
            </p>
            <h2 className="oswald text-4xl font-bold text-gray-900 mb-4">
              Same-Day. No Hassle. Honest Pricing.
            </h2>
            <p className="text-gray-500 leading-relaxed mb-4">
              LOW Price Junk Removal is London's go-to hauling crew — built for homeowners, landlords, and businesses who need fast, reliable junk removal without the runaround.
            </p>
            <p className="text-gray-500 leading-relaxed mb-6">
              Same-day availability, no hidden fees, and a friendly team that shows up on time and gets the job done right.
            </p>
      ...
      <section id="contact" className="py-20 px-8 md:px-20" style={{ background: business.colorDark }}>
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-400 mb-12 max-w-lg">
            Call us or send a message — we'll get back to you fast with a fair quote.
          </p>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input type="text" placeholder="John" className="border border-white/10 rounded-lg px-4 py-3 text-white text-sm placeholder-slate-500 focus:outline-none" style={{ background: "rgba(255,255,255,0.07)" }} />
                </div>
                <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input type="tel" placeholder="(226) 000-0000" className="border border-white/10 rounded-lg px-4 py-3 text-white text-sm placeholder-slate-500 focus:outline-none" style={{ background: "rgba(255,255,255,0.07)" }} />
              </div>
              <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea rows={4} placeholder="What do you need removed?" className="border border-white/10 rounded-lg px-4 py-3 text-white text-sm placeholder-slate-500 focus:outline-none resize-none" style={{ background: "rgba(255,255,255,0.07)" }} />
              </div>
